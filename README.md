...
- **Subagent Delegation**, Spawn child agents for subtasks via `SubagentSystem`. Named subagent registry, isolated execution, skill inheritance, and automatic result aggregation with the `delegate` tool.
