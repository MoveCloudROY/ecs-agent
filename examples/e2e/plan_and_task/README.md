...
| `plan_task_plan_qa_review_ignored` | info | `controller.py` | Late plan QA verdict ignored because an approved verdict for that phase is already sticky; `workflow_id=`, `verdict=` |
