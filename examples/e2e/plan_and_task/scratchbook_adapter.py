...
Uses ArtifactRegistry for atomic writes and canonical artifact IDs.
"""
...
class PlanTaskScratchbookAdapter:
    ...
    def write_plan(self, content: str) -> str:
        ...
        if plan_path.exists():
            ...
            _write_text_atomic(version_path, current_content)
    ...
    def write_state(self, state: RuntimeState) -> str:
        ...
        _write_text_atomic(state_path, state.to_json())
        logger.info(
    ...
    def write_review_verdict(self, phase: str, verdict: ReviewVerdict) -> str:
        """Persist a review verdict via ArtifactRegistry for canonical artifact ID."""
        ...
        _write_text_atomic(review_path, content)
        logger.info(
