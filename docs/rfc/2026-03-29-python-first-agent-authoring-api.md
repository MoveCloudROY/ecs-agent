...
class Agent:
    ...
    @classmethod
    def builder(cls, *, provider: LLMProvider | None = None, model: str | None = None) -> AgentBuilder: ...

    @classmethod
    def from_spec(cls, spec: AgentSpec, *, provider_factory: ProviderFactory) -> Agent: ...

    @classmethod
    def from_specs(cls, specs: dict[str, AgentSpec], *, provider_factory: ProviderFactory) -> BuiltAgent: ...
...
```python
class AgentBuilder:
    def provider(self, provider: LLMProvider, *, model: str | None = None) -> AgentBuilder: ...
